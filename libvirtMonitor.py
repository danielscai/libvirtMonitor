...
class PNPStore(Store):
    ...
    tmpl="DATATYPE::SERVICEPERFDATA\tTIMET::%s\tHOSTNAME::%s\tSERVICEDESC::%s\tSERVICEPERFDATA::%s=%s;\tSERVICECHECKCOMMAND::dummy_command\tHOSTSTATE::UP\tHOSTSTATETYPE::HARD\tSERVICESTATE::OK\tSERVICESTATETYPE::HARD\n"
